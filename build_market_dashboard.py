...
'''
    etf_late_ui = "setTimeout(()=>{" + etf_detail_ui + "},0);"
    trade_plan_ui = stock_agent_ui + valuation_ui + etf_share_ui + news_ui + news_switch_ui + news_detail_ui + overseas_corr_ui + stock_final_ui + news_link_ui + etf_late_ui + r'''
